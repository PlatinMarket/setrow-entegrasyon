 ...
 */
 if (empty(Configure::read('debug'))) Configure::write('debug', 0);
 ...
 */
	Configure::write('Security.salt', 'DYhG93sdffds34567WwvniRfgsdFSDaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76853344467768345799683990645');
